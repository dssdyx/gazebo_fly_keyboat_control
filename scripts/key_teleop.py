...
class SimpleKeyTeleop():
    def __init__(self, interface):
        ...
        self._pub_px4 = rospy.Publisher('/gesture/command',String)
    ...
    def _set_velocity(self):
        ...
        px4_cmd = 'undo'
        for k in keys:
            px4_cmd = self.movement_bindings[k]
        self._px4_cmd = px4_cmd
    ...
    def _publish(self):
        ...
        cmd_string = self._get_string(self._px4_cmd)
        self._pub_px4.publish(cmd_string)
